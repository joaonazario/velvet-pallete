let bodySiteBatom = document.querySelector('body');

//Manipulando o elemento video
var video = document.getElementById('videoHerrera');
...
bodySiteBatom.appendChild(rodaPe);
