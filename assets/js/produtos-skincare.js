let bodySkinCare = document.querySelector('body');

let styleMidPage = document.getElementById('midpage');
styleMidPage.style.width = 'inherit';
// Criando footer
...
bodySkinCare.appendChild(rodaPe);
